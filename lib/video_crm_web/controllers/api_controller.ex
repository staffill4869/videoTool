defmodule VideoCRMWeb.ApiController do
  @moduledoc """
  ...
  alias VideoCRM.{Insights, MCP, Presets, Projects, Prompt, Repo, Series, Work}

  action_fallback VideoCRMWeb.FallbackController
