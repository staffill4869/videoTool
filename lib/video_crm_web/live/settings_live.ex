defmodule VideoCRMWeb.SettingsLive do
  @moduledoc """
  ...
  alias VideoCRM.{Publishing, Settings}
  alias VideoCRM.Publishing.GoogleOAuth
    ...
    assign(socket,
      ...
      secrets:
        Enum.map(Settings.secrets(), fn {key, _ref, env, label, help} ->
          %{key: key, env: env, label: label, help: help, masked: Settings.masked(key)}
        end),
        ...
        <form :for={s <- @secrets} phx-submit="save_secret" class="card bg-base-200">
          <div class="card-body gap-2 p-3">
            ...
            <div class="flex flex-wrap items-center justify-between gap-2">
              ...
              <span :if={s.masked} class="font-mono text-xs text-success">{s.masked}</span>
