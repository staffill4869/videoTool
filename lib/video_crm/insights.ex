defmodule VideoCRM.Insights.Metric do
  @moduledoc false
  use Ecto.Schema
  import Ecto.Changeset

  alias VideoCRM.Publishing.Publication
...
defmodule VideoCRM.Insights do
  @moduledoc """
  발행물 성과 집계.
  ...
  alias VideoCRM.Insights.Metric
  alias VideoCRM.Publishing.Publication
  alias VideoCRM.Repo
  alias VideoCRM.YouTube
