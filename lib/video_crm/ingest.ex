defmodule VideoCRM.Ingest do
  ...
  alias VideoCRM.{Ffmpeg, Jobs, Mapping, Media, Phash, Projects, Validation}
  ...
  def downloads_dir do
    Application.get_env(:video_crm, :downloads_dir) ||
  ...
  defp method_used do
    if VideoCRM.Ocr.available?(), do: "ocr", else: "phash"
  end
